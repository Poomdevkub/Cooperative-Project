        ...
        <div class="card shadow-sm" style="width: 100%; max-width: 600px;">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><strong>รายละเอียดบริษัท:</strong> {{ $company->compDescription }}</li>
                    <li class="list-group-item"><strong>โมเดลบริษัท:</strong> {{ $company->compModel }}</li>
                    <li class="list-group-item"><strong>ที่อยู่บริษัท:</strong> {{ $company->compAddress }}</li>
                    <li class="list-group-item"><strong>โทรศัพท์บริษัท:</strong> {{ $company->compPhone }}</li>
                    <li class="list-group-item"><strong>Email บริษัท:</strong> {{ $company->compEmail }}</li>
                    <li class="list-group-item"><strong>เว็บไซต์บริษัท:</strong> <a href="{{ $company->compWebsite }}" target="_blank">{{ $company->compWebsite }}</a></li>
